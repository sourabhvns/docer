...
<body>
	<div id="wrapper">
        ...
        <nav>        
            <div class="nav" style="background:#FFCFAF; color:black;">Home</div>
            <a href="search.php"><div class="nav">Search</div></a>
            <div class="nav">Downloads</div>
            <a href="help.php"><div class="nav">Help</div>
            <a href="contact.php"><div class="nav">Contact Us</div></a>
        </nav>
        <div id="border"></div>
        <div id="workarea" style="height:700px;">
